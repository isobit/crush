...
func (m *BackgroundShellManager) Start(ctx context.Context, workingDir string, blockFuncs []BlockFunc, command string, description string, sandbox *SandboxConfig) (*BackgroundShell, error) {
	// Check job limit
