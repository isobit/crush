...
func (m *UI) updateSidebarScrollState() {
	...
	cwd := common.LabeledPath(t, "cwd", m.com.Workspace.WorkingDir(), contentWidth)

	var dataDir string
	if cfg := m.com.Config(); cfg != nil {
		defaultDataDir := filepath.Join(m.com.Workspace.WorkingDir(), ".crush")
		if cfg.Options.DataDirectory != defaultDataDir {
			dataDir = common.LabeledPath(t, "data", cfg.Options.DataDirectory, contentWidth)
		}
	}
