...
func (w *AppWorkspace) MessageDelete(ctx context.Context, id string) error {
...
func (w *AppWorkspace) PermissionGrantAlways(perm permission.PermissionRequest) {
	w.app.Permissions.GrantAlways(perm)
}
