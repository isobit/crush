...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/permissions/permissive", c.handleGetWorkspacePermissionsPermissive)
	mux.HandleFunc("POST /v1/workspaces/{id}/permissions/permissive", c.handlePostWorkspacePermissionsPermissive)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/agent/retry", c.handlePostWorkspaceAgentRetry)
