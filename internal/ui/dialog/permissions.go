...
func (p *Permissions) hasDiffView() bool {
	...
	case tools.EditToolName, tools.WriteToolName, tools.MultiEditToolName, tools.HashlineEditToolName, tools.ReplaceSymbolToolName:
		return true
	}
	return false
}
...
func (p *Permissions) renderHeader(contentWidth int) string {
	...
	case tools.EditToolName, tools.WriteToolName, tools.MultiEditToolName,
		tools.ViewToolName, tools.HashlineEditToolName, tools.ReplaceSymbolToolName,
	...
	case tools.EditToolName, tools.WriteToolName, tools.MultiEditToolName, tools.ViewToolName, tools.HashlineEditToolName, tools.ReplaceSymbolToolName:
		var filePath string
